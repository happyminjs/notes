...
5、代码很不规范，很多用单个字母命名的变量方法，读代码了解业务细节十分困难
```
...
------------------------
因为之前对电商有一些比较扎实的积累，比如对前端架构和业务设计，所以对商城方向能快速的对架构设计进行了清晰的模块区分 ，能快速规划出清晰的核心模块拆分
比如区分售前（活动、运营）、售中（列表、详情、下订单）、售后（订单、退货退款）
第一期是时间最紧张的，所以主要售中和售后
